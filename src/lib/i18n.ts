...
const en: Dict = {
  ...
  editorial: {
    title: "Editorial",
    heading: "Editorial export",
    intro:
      "Every drawing you validated, paired with its chosen plate and notes — laid out as a book page, ready to print or save as PDF, chapter by chapter.",
    platesTotal: "{n} plates",
    print: "Print / PDF",
    back: "All chapters",
    plate: "Plate",
    enlarge: "Enlarge",
    empty: "No validated drawings yet. Mark graphics as “correct” in the diagram review to build the book.",
    emptyChapter: "No validated drawings in this chapter yet.",
  },
  capture: {
    title: "Capture a graphic",
    hint: "Missing a drawing? Crop it from the facsimile with Win+Shift+S, then paste it here (Ctrl+V) — or drop / upload an image. It becomes a graphic for this page in Diagrams.",
    pasteHere: "Click here and paste (Ctrl+V), or drop an image",
    upload: "Upload",
    saving: "Saving…",
    saved: "Added — it appears in Diagrams for this page.",
  ...
  books: {
    ...
    contents: "Contents",
    inBookSearch: "Search in this book…",
    inBookMatches: "{n} matches",
    inBookNoMatch: "No matches in this book.",
  ...
  diagrams: {
    ...
    versions: {
      manage: "Versions",
      model: "Model",
      setPlate: "Use as editorial plate",
    ...
    notes: {
      manage: "Notes & tags",
      note: "Note for this image",
      notePlaceholder: "Observations, references, reading notes…",
      categories: "Categories",
      themes: "Themes",
      addCategory: "Add or pick a category",
      addTheme: "Add or pick a theme",
      save: "Save note",
      saving: "Saving…",
    },
  },
...
const de: Dict = {
  ...
  editorial: {
    title: "Edition",
    heading: "Editorischer Export",
    intro:
      "Jede von dir validierte Zeichnung mit ihrer gewählten Tafel und Notizen — als Buchseite gesetzt, druckfertig oder als PDF, Kapitel für Kapitel.",
    platesTotal: "{n} Tafeln",
    print: "Drucken / PDF",
    back: "Alle Kapitel",
    plate: "Tafel",
    enlarge: "Vergrößern",
    empty: "Noch keine validierten Zeichnungen. Markiere Grafiken in der Diagramm-Prüfung als „korrekt“, um das Buch aufzubauen.",
    emptyChapter: "In diesem Kapitel noch keine validierten Zeichnungen.",
  },
  capture: {
    title: "Grafik erfassen",
    hint: "Fehlt eine Zeichnung? Schneide sie mit Win+Umschalt+S aus dem Faksimile aus und füge sie hier ein (Strg+V) — oder ziehe / lade ein Bild hoch. Sie wird zu einer Grafik dieser Seite in den Diagrammen.",
    pasteHere: "Hier klicken und einfügen (Strg+V) oder Bild ablegen",
    upload: "Hochladen",
    saving: "Wird gespeichert…",
    saved: "Hinzugefügt — erscheint in den Diagrammen dieser Seite.",
  ...
  books: {
    ...
    contents: "Inhalt",
    inBookSearch: "In diesem Buch suchen…",
    inBookMatches: "{n} Treffer",
    inBookNoMatch: "Keine Treffer in diesem Buch.",
  ...
  diagrams: {
    ...
    versions: {
      manage: "Versionen",
      model: "Modell",
      setPlate: "Als Editions-Tafel verwenden",
    ...
    notes: {
      manage: "Notizen & Schlagwörter",
      note: "Notiz zu diesem Bild",
      notePlaceholder: "Beobachtungen, Verweise, Lesenotizen…",
      categories: "Kategorien",
      themes: "Themen",
      addCategory: "Kategorie hinzufügen oder wählen",
      addTheme: "Thema hinzufügen oder wählen",
...
const es: Dict = {
  ...
  editorial: {
    title: "Editorial",
    heading: "Exportación editorial",
    intro:
      "Cada dibujo que validaste, junto con su lámina elegida y tus notas — maquetado como una página de libro, listo para imprimir o guardar en PDF, capítulo a capítulo.",
    platesTotal: "{n} láminas",
    print: "Imprimir / PDF",
    back: "Todos los capítulos",
    plate: "Lámina",
    enlarge: "Ampliar",
    empty: "Aún no hay dibujos validados. Marca gráficos como «correcto» en la revisión de diagramas para construir el libro.",
    emptyChapter: "Aún no hay dibujos validados en este capítulo.",
  },
  capture: {
    title: "Capturar un gráfico",
    hint: "¿Falta un dibujo? Recórtalo del facsímil con Win+Mayús+S y pégalo aquí (Ctrl+V) — o arrastra / sube una imagen. Quedará como gráfico de esta página en Diagramas.",
    pasteHere: "Haz clic aquí y pega (Ctrl+V), o suelta una imagen",
    upload: "Subir",
    saving: "Guardando…",
    saved: "Añadido — aparece en Diagramas de esta página.",
    tooLarge: "Imagen demasiado grande (máx. 8 MB).",
    error: "Falló la captura.",
  },
  account: {
  ...
  books: {
    ...
    contents: "Contenido",
    inBookSearch: "Buscar en este libro…",
    inBookMatches: "{n} coincidencias",
    inBookNoMatch: "Sin coincidencias en este libro.",
  ...
  diagrams: {
    ...
    versions: {
      manage: "Versiones",
      model: "Modelo",
      setPlate: "Usar como lámina editorial",
      generate: "Generar (IA)",
    ...
    notes: {
      manage: "Notas y etiquetas",
      note: "Nota para esta imagen",
      notePlaceholder: "Observaciones, referencias, notas de lectura…",
      categories: "Categorías",
      themes: "Temas",
      addCategory: "Añadir o elegir una categoría",
      addTheme: "Añadir o elegir un tema",
      save: "Guardar nota",
      saving: "Guardando…",
    },
  },
